...
public class TileEntryActivity extends Activity {
    ...
    private static final String RESOLUTION_TILE = "com.android.displayres.ResolutionTileService";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (RESOLUTION_TILE.equals(sourceClassName)) {
            intent = new Intent(this, ResolutionActivity.class);
        } else {
