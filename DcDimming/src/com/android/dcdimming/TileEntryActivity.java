...
import com.android.dcdimming.DcDimmingSettingsActivity;

public class TileEntryActivity extends Activity {
    private static final String TAG = "TileEntryActivity";
    private static final String DCDIMMING_TILE = "com.android.dcdimming.DcDimmingTileService";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (DCDIMMING_TILE.equals(sourceClassName)) {
