...
public class SearchIndexingProvider extends SearchIndexablesProvider {
    ...
    public Cursor queryRawData(String[] projection) {
        ...
        row[COLUMN_INDEX_RAW_TITLE]                = context.getString(R.string.thermal_title);
        row[COLUMN_INDEX_RAW_SUMMARY_ON]           = context.getString(R.string.thermal_summary);
        row[COLUMN_INDEX_RAW_SUMMARY_OFF]          = context.getString(R.string.thermal_summary);
        row[COLUMN_INDEX_RAW_KEYWORDS]             = context.getString(R.string.thermal_title);
        row[COLUMN_INDEX_RAW_SCREEN_TITLE]         = context.getString(R.string.thermal_title);
        row[COLUMN_INDEX_RAW_ICON_RESID]           = 0;
        row[COLUMN_INDEX_RAW_INTENT_ACTION]        = "com.android.settings.action.IA_SETTINGS";
        row[COLUMN_INDEX_RAW_INTENT_TARGET_PACKAGE] = "com.android.thermal";
        row[COLUMN_INDEX_RAW_INTENT_TARGET_CLASS]  = "com.android.thermal.ThermalActivity";
        row[COLUMN_INDEX_RAW_KEY]                  = "com.android.thermal.search_key";
